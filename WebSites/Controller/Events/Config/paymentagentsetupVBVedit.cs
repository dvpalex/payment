...
namespace Controller.Lib.Views.Ev.PaymentAgentSetupVBVEdit
{
    public class Save : BaseEvent
    {
        protected override BaseCommand OnExecute()
        {
            ...
            MPaymentAgentSetupVBV mPaymentAgentSetupVBV = (MPaymentAgentSetupVBV)this.GetMessage(typeof(MPaymentAgentSetupVBV));

            PaymentAgentSetupVBV.Save(mPaymentAgentSetupVBV);
