<%@ Page Language="C#" MasterPageFile="~/Store/default/sp.master" AutoEventWireup="true" CodeFile="checkpopup.aspx.cs" Inherits="Agents_VBV33_checkpopup" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="content" runat="Server">
    <script type="text/javascript" language='JavaScript'>
		...
		function openVBV33PopUp()
		{
			if(navigator.appName.indexOf("Netscape") != -1)
				vbv33PopUp = window.open("start.aspx", "VerifiedByVisa","toolbar=0,location=0,directories=0,status=1,menubar=0,scrollbars=1,resizable=0,width=600,height=420"); //screenX=0,screenY=0,left=0,top=0
			else
				vbv33PopUp = window.open("start.aspx", "VerifiedByVisa","toolbar=0,location=0,directories=0,status=1,menubar=0,scrollbars=1,resizable=1,width=600,height=420");
		...
		function focusPopUp()
		{
			if ( vbv33PopUp != undefined )
			{
				try { vbv33PopUp.focus(); } catch (e) {}
			}
		}
		...
		function closeVBV33()
		{
			if ( vbv33PopUp != undefined ) { vbv33PopUp.close() } ;
		}
    ...
    <div id="content" runat="server">
        <div id="divStart" style="display: none; text-align: center">
            ...
            <p>
            <a href="javascript:openVBV33PopUp();"><font size="1" face="Verdana, Arial, Helvetica, sans-serif">clique aqui para iniciar</font></a></p>
        </div>
