...
<body>
    ...
    <form name="sendorder" id="sendorder" action="<%=System.Configuration.ConfigurationManager.AppSettings["urlHandshakeHTML"]%>?idioma=<%=Request["IDIOMA"]%>" method="post">
        ...
        <input type="hidden" value="TESTE NOVA CONEXÃO" name="NOME" />
        <input type="hidden" value="03288912000107" name="CGC" /> <!-- 03288912000107 -->
        <input type="hidden" value="TESTE NOVA CONEXÃO" name="RAZAO_PJ" />
        <input type="hidden" value="253909139" name="INSCRICAO_PJ" />
        <input type="hidden" value="TEST TEST" name="NOME_RESP_PJ" />
        <input type="hidden" value="" name="CPF_RESP_PJ" />
        ...
        <input type="hidden" name="PPAGAMENTO" value="32" />
        ...
        <input type="hidden" name="DAT_VENCIMENTO1_ABN" value="30/09/2006" />
        <input type="hidden" name="QtdParcelas_ABN" value="4" />
        
        <input type="hidden" name="LINKBOTAO6" value="http://homolog.superpag.com.br" />
