<%@ Page Language="C#" MasterPageFile="~/Store/default/sp.master" AutoEventWireup="true" CodeFile="Call2Party.aspx.cs" Inherits="Agents_PaymentClientVirtual_Call2Party" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="extraHtml" runat="Server">
    <form id="amex" name="amex" action="Request2Party.aspx" method="POST">
        <input type="hidden" name="idteste" value="teste" />
    </form>
    <script type="text/javascript">
      var form = document.getElementById("amex");
      form.submit();
    </script>
</asp:Content>
