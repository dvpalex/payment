<%@ page language="C#" autoeventwireup="true" inherits="error, App_Web_o3l0suwz" culture="auto" uiculture="auto" meta:resourcekey="PageResource1" %>
...
<body>
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="452">
        <tr>
            <td colspan="2" valign="middle"><img src="App_Themes/default/images/x1.png" alt=""/></td>
        </tr>
        <tr style="background-color: #F6F6F6; padding-top: 20px; padding-bottom: 10px;">
            <td style="text-align: right; padding-right: 10px; width: 50px;">
                <img src="App_Themes/default/images/error.gif" border="0" alt=""/>
            </td>
        ...
        <tr style="background-image: url('/Images/x2.png');">
            <td colspan="2"><img src="App_Themes/default/images/x2.png" border="0" alt=""/></td>
        </tr>
    </table>
        </div>        
    </form>
