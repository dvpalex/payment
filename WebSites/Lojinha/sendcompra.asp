...
<%
  ...
  if bSendPost then
    ...
    If Len(pedido_cookie) > 3 And Left(pedido_cookie, 3) = "TVT" Then
      pedido_cookie = Right(Len(pedido_cookie) - 3)
    End If
...
<INPUT type=hidden name=DAT_VENCIMENTO1_ABN value="20/08/2006">
<INPUT type=hidden name=QtdParcelas_ABN value=24>
</FORM>
