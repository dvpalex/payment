...
<asp:Content ID="Content1" ContentPlaceHolderID="Conteudo" Runat="Server">
    ...
    <fwc:MsgDataGrid id="grdActionPlane" ShowFooter="False" runat="server" MsgSource="MPaymentAttempt" MsgSourceField="Order.Itens">
		<Columns>
			...
			<fwc:MessageColumn CustomFormat="None" MaxLength="0" id="rmcItemValue" Field="ItemValue" CustomTotalFormat="None" Totalizar="False" HeaderText="Valor unitário" HelpAction=""></fwc:MessageColumn>
		</Columns>
    </fwc:MsgDataGrid>
    <br />
	<!--Painel de Sumario-->
