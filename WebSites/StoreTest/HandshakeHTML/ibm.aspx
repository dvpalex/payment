...
<body>
    ...
    <form name="sendorder" id="sendorder" action="<%=System.Configuration.ConfigurationManager.AppSettings["urlHandshakeHTML"]%>?idioma=<%=Request["IDIOMA"]%>" method="post">
        ...
        <input type="hidden" name="PPAGAMENTO" value="2" />
        <input type="hidden" name="BANDEIRA" value="41" />
        <input type="hidden" name="PQTDPARCELAS" value="2" />
        ...
        <input type="hidden" name="ENVIA_EMAIL_CLIENTE" value="1" />
