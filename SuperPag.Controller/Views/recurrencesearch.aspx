<%@ Page Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeFile="recurrencesearch.aspx.cs" Inherits="Views_recurrencesearch" %>
			...
			<table class="tbPainelSNZ" cellpadding="0" cellspacing="0">
				<tr>
					<td class="tdPainelSNZ">
						<asp:label id="lblTituloSNZ" runat="server">Recorrências</asp:label>
					</td>
				</tr>
				<tr>
					<td class="tdSubTituloSNZ">
						<asp:label id="Label5" runat="server">Busca de recorrências</asp:label>
					</td>
				</tr>
			</table>
			<table id="tbCentral">
				<tr>
					<td id="tdCentral">
						<table class="tbPainelFRM">
							...
							<tr>
								<td class="tdLabelFRM">
									<asp:label id="Label15" runat="server">Data recorrência de:</asp:label></td>
							...
							<tr>
								<td class="tdLabelFRM">
									<asp:label id="Label12" runat="server">Status da recorrência</asp:label></td>
								<td class="tdCampoFRM" align="left" colspan="3">
