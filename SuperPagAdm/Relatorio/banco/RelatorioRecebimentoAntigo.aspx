<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Relatorio_Default, App_Web_lepo16fd" %>
            ...
            <td align="left" class="tdCampoFRM">
                ...
                <td>
                    &nbsp;<asp:RadioButtonList ID="rdTipoData" runat="server" Height="19px" RepeatDirection="Horizontal"
                        Width="248px">
                        <asp:ListItem Selected="True" Value="1">Data da Transa&#231;&#227;o</asp:ListItem>
                        <asp:ListItem Value="0">Data do Arquivo</asp:ListItem>
            ...
            <td class="tdCampo" colspan="6" align="center" valign="top">  
                <div class="dvPanel"><asp:GridView runat="server" ID="GridRel" GridLines="None" CellPadding="0" CellSpacing="1"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="DataArquivo" HeaderText="Data" DataFormatString="{0:dd/MM/yyyy}" >
                            </asp:BoundField>
                            ...
                            <asp:BoundField DataField="DescricaoOcorrencia" HeaderText="Ocorr&#234;ncia" />
