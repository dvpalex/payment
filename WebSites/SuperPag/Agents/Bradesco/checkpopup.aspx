<%@ Page Language="C#" MasterPageFile="~/Store/default/sp.master" AutoEventWireup="true" CodeFile="checkpopup.aspx.cs" Inherits="Agents_Bradesco_checkpopup" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="content" runat="Server">
    <script type="text/javascript" language='JavaScript'>
		...
		window.name = "frameRetorno";
		
		function openBradescoPopUp()
		{
			if(navigator.appName.indexOf("Netscape") != -1)
				BradescoPopUp = window.open("start.aspx?id=<%= Session["PaymentAttemptId"] %>", "Bradesco","toolbar=0,location=0,directories=0,status=1,menubar=0,scrollbars=1,resizable=0,width=750,height=420"); //screenX=0,screenY=0,left=0,top=0
			else
				BradescoPopUp = window.open("start.aspx?id=<%= Session["PaymentAttemptId"] %>", "Bradesco","toolbar=0,location=0,directories=0,status=1,menubar=0,scrollbars=1,resizable=1,width=750,height=420");
		...
		{	
			if(BradescoPopUp.closed)
			{
				document.formBradescoReturn.submit();
		...
		function focusPopUp()
		{
			if ( BradescoPopUp != undefined )
			{
				try { BradescoPopUp.focus(); } catch (e) {}
			}
		}
		...
		function closeBradesco()
		{
			if ( BradescoPopUp != undefined ) { BradescoPopUp.close() } ;
		}
    ...
    <div id="content" runat="server">
        <div id="divStart" style="display: none; text-align: center">
            ...
            <p>
            <a href="javascript:openBradescoPopUp();"><font size="1" face="Verdana, Arial, Helvetica, sans-serif">clique aqui para iniciar</font></a></p>
        </div>
        <div id="divWait" style="text-align: center">
            <table width="610" border="0" cellpadding="0" cellspacing="3">
                <tr>
                    <td><img src="../../images/Bradesco/Tit_Pagamento.gif" width="600" height="115" border="0"></td>
                </tr>
                <tr>
                    <td align="center">		
                        <div align="center">
...
<asp:Content ID="Content3" ContentPlaceHolderID="extraHtml" runat="Server">
    <form name="formBradescoReturn" id="formBradescoReturn" action="naoaprovada.aspx">
