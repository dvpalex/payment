<%@ Page Language="C#" MasterPageFile="~/Store/default/sp.master" AutoEventWireup="true" CodeFile="komerciws.aspx.cs" Inherits="Agents_KomerciWS_komerciws" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="extraHtml" runat="Server">
    <form id="komerciws" name="komerciws" action="result.aspx" method="POST">
    </form>
    <script type="text/javascript">
      var form = document.getElementById("komerciws");
      form.submit();
    </script>
</asp:Content>
