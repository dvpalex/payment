<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Relatorio_Default, App_Web_qcmmqrpz" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table class="tbPainelFRM">
        <tr>
            <td align="center" colspan="2" class="tdBarraFerramentasSUM" style="height: 14px">
            ...
            <td class="tdCampoFRM" >
                <asp:TextBox ID="txtInicial" runat="server" MaxLength="10" onkeypress="mascara(event,this,'data')"
                    Width="100px"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator2"
                        runat="server" ControlToValidate="txtInicial" ErrorMessage="*"></asp:RequiredFieldValidator>
                Obs: Data de operação do Banco.
            </td>
        </tr>
        <tr>
            <td class="tdLabelFRM" align="left">
            ...
            <td align="left" class="tdCampoFRM">
                <asp:DropDownList ID="ddlBanco" runat="server" DataTextField="NBanco" DataValueField="numBanc"
                    Width="204px" OnSelectedIndexChanged="ddlBanco_SelectedIndexChanged">
                </asp:DropDownList></td>
        </tr>
        <tr>
            <td align="left" class="tdCampoFRM" colspan="2" style="height: 27px">
                <asp:Button ID="btnBuscar" runat="server" OnClick="btnBuscar_Click" Text="Buscar"
                    BorderStyle="Solid" BorderWidth="1px" Width="87px" /></td>
        </tr>
        <tr>
            <td class="tdCampoFRM" colspan="2" style="height: 21px">
