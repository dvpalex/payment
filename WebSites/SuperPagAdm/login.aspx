<%@ Page Language="C#" AutoEventWireup="true" CodeFile="login.aspx.cs" Inherits="_DefaultLogin" %>
        ...
        <div id="Login">
            ...
            <div id="Loginconteudo">
                <asp:Login CssClass="textlogin" ID="LoginController" runat="server" FailureText="Acesso negado"
                    ...
                    TitleText="" DestinationPageUrl="~/Default.aspx" DisplayRememberMe="False" OnAuthenticate="LoginController_Authenticate">
                </asp:Login>
            </div>
            <div id="Loginbottom">
                </div>
