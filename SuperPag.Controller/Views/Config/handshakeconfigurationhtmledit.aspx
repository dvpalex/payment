<%@ Page Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeFile="handshakeconfigurationhtmledit.aspx.cs" Inherits="Views_handshakeconfigurationhtmledit" %>
				...
				<table class="tbPainelFRM">
					<tr>
						<td class="tdBarraFerramentasSUM" colspan="4">
							<asp:label id="Label2" runat="server">Cadastro do Handshake HTML</asp:label>
						</td>
					</tr>
                    <tr>
						<td class="tdLabelFRM">
						...
						<td class="tdCampoFRM" align="left">
						    <fwc:MsgLabel id="lblPaymentAgentSetupId" runat="server" MsgSource="MHandshakeConfigurationHtml" Width="100px"
					 ...
					 <tr>
						...
						<td class="tdCampoFRM" align="left">
							<fwc:MsgTextBox id="MsgTextBox2" runat="server" MsgSource="MHandshakeConfigurationHtml" MaxLength="300" Width="400px"
                    ...
                    <tr>
						...
						<td class="tdCampoFRM" align="left">
							<fwc:MsgTextBox id="MsgTextBox1" runat="server" MsgSource="MHandshakeConfigurationHtml" MaxLength="300" Width="400px"
					 ...
					 <tr>
						...
						<td class="tdCampoFRM" align="left">
							<fwc:MsgTextBox id="MsgTextBox3" runat="server" MsgSource="MHandshakeConfigurationHtml" MaxLength="300" Width="400px"
					 ...
					 <tr>
						...
						<td class="tdCampoFRM" align="left">
							<fwc:MsgTextBox id="MsgTextBox4" runat="server" MsgSource="MHandshakeConfigurationHtml" MaxLength="300" Width="400px"
					 ...
					 <tr>
						...
						<td class="tdCampoFRM" align="left">
							<fwc:MsgTextBox id="MsgTextBox5" runat="server" MsgSource="MHandshakeConfigurationHtml" MaxLength="300" Width="400px"
					 ...
					 <tr>
						...
						<td class="tdCampoFRM" align="left">
							<fwc:MsgTextBox id="MsgTextBox6" runat="server" MsgSource="MHandshakeConfigurationHtml" MaxLength="300" Width="400px"
					 ...
					 <tr>
						...
						<td class="tdCampoFRM" align="left">
							<fwc:MsgTextBox id="MsgTextBox7" runat="server" MsgSource="MHandshakeConfigurationHtml" MaxLength="50" Width="200px"
					 ...
					 <tr>
						...
						<td class="tdCampoFRM" align="left">
							<fwc:MsgTextBox id="MsgTextBox8" runat="server" MsgSource="MHandshakeConfigurationHtml" MaxLength="50" Width="200px"
