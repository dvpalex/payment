<%@ Page Language="C#" MasterPageFile="~/Store/default/sp.master" AutoEventWireup="true" CodeFile="checkpopup.aspx.cs" Inherits="Agents_VBVInBox_checkpopup" %>
    ...
    <script type="text/javascript" language='JavaScript'>
		...
		function openVBVPopUp()
		{
		    if(navigator.appName.indexOf("Netscape") != -1)
			    vbvPopUp = window.open("start.aspx?id=<%= Session["PaymentAttemptId"] %>", "VerifiedByVisa","toolbar=0,location=0,directories=0,status=1,menubar=0,scrollbars=1,resizable=0,width=600,height=420"); //screenX=0,screenY=0,left=0,top=0
		    else
			    vbvPopUp = window.open("start.aspx?id=<%= Session["PaymentAttemptId"] %>", "VerifiedByVisa","toolbar=0,location=0,directories=0,status=1,menubar=0,scrollbars=1,resizable=1,width=600,height=420");
