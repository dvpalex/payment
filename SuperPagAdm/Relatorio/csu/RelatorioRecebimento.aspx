<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Relatorio_Default, App_Web_rhi1vmto" %>
            ...
            <td class="tdCampo" colspan="6" align="center" valign="top">                
                    <asp:GridView runat="server" ID="GridRel" GridLines="None" CellPadding="0" CellSpacing="1"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="DataCapturaArquivo" HeaderText="Recebimento" DataFormatString="{0:dd/MM/yyyy}" >
                            </asp:BoundField>
