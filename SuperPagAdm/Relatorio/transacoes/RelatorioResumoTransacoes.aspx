<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Relatorio_Default, App_Web_0z6jnhtn" %>
        ...
        <tr class="tdCampoFRM">
            <td align="left" class="tdCampoFRM">
                ...
                <td colspan=2><asp:RadioButtonList ID="rdTipoData" runat="server" Height="19px" RepeatDirection="Horizontal"
                        ...
                        <asp:ListItem Value="2">Data de Vencimento</asp:ListItem>
                    </asp:RadioButtonList>
                    </td><td></td>
        </tr>       
        <tr>
            ...
            <td class="tdCampo" colspan="6" align="center" valign="top">                
                    <asp:GridView runat="server" ID="GridRel" GridLines="None" CellPadding="0" CellSpacing="1"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="TotalTransacoes" HeaderText="Total">
                            </asp:BoundField>
