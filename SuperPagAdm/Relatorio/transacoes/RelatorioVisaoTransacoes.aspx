<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Relatorio_Default, App_Web_l6xx2zkn" %>
            ...
            <td class="tdCampo" colspan="6" align="center" valign="top">                
                    <div class="dvPanel"><asp:GridView runat="server" ID="GridRel" GridLines="None" CellPadding="0" CellSpacing="1"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="DataPagamento" HeaderText="Pagamento" DataFormatString="{0:dd/MM/yyyy}" />
                            <asp:BoundField DataField="DataProcessamento" HeaderText="Transa&#231;&#227;o" DataFormatString="{0:dd/MM/yyyy}" />
