<%@ Page Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeFile="orderlist.aspx.cs" Inherits="Views_orderlist" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Conteudo" Runat="Server">
	...
	<fwc:MsgDataGrid runat="server" id="grdOrder" MsgSource="MCOrder" OnMessageEvent="grdOrder_MessageEvent" AllowSorting="True" OnSortCommand="grdOrder_SortCommand">
		<Columns>
			...
			<fwc:MessageColumn CustomFormat="NumDecimal_2casa" MaxLength="0" id="emcFinalAmount" Field="FinalAmount" CustomTotalFormat="None" Totalizar="False" HeaderText="Valor" HelpAction=""></fwc:MessageColumn>
			...
			<fwc:MessageColumn CustomFormat="DataHora" MaxLength="0" id="emcStartDate" Field="CreationDate" CustomTotalFormat="None" Totalizar="False" HeaderText="Data do pedido" HelpAction=""></fwc:MessageColumn>
		</Columns>
	</fwc:MsgDataGrid>
</asp:Content>