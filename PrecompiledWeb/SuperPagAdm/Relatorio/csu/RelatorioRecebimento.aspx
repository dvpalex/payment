<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Relatorio_Default, App_Web_xfxasyqe" %>
    ...
    <table class="tbPainelFRM">
        <tr>
            <td align="center" colspan="4" class="tdBarraFerramentasSUM">
                Relatório de Recebimento CSU</td>
        </tr>
        <tr class="tdCampoFRM">
            ...
            <td class="tdCampo" colspan="6" align="center" valign="top">                
                    <asp:GridView runat="server" ID="GridRel" GridLines="None" CellPadding="0" CellSpacing="1"
                        ...
                        <Columns>
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:ImageButton ID="imgLogCSU" runat="server" CommandName="LogCSU" ImageUrl="~/App_Themes/default/images/filenew.gif" OnCommand="VerTransacoes_click" CommandArgument='<%# Eval("NomeArquivoCapturado") %>' />
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:BoundField DataField="DataArquivo" HeaderText="Data Transação" DataFormatString="{0:dd/MM/yyyy}" >
                            </asp:BoundField>
                            <asp:BoundField DataField="DataCapturaArquivo" HeaderText="Data Arquivo" DataFormatString="{0:dd/MM/yyyy}" >
                            </asp:BoundField>
                            <asp:BoundField DataField="NomeArquivoCapturado" HeaderText="Arquivo">
                            </asp:BoundField>
